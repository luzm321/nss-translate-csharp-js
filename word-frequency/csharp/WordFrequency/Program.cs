...
namespace WordFrequency
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Or: string s1 = Regex.Replace(s, "[^A-Za-z0-9 -]", ""); where s is the string to be replaced
            ...
            // Creating a C# dictionary, setting the initial value to an empty object, and implementing the ContainsKey() method
